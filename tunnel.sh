...
<body>
    ...
    <div class="announce-bar" id="announceBar">
        ...
        <button class="announce-close" onclick="closeAnnounce()" aria-label="Tutup">&times;</button>
    </div>

    <!-- ============ POPUP PROMO ============ -->
    <div class="popup-overlay" id="promoPopup">
        <div class="popup-modal">
            <button class="popup-close" onclick="closePromo()" aria-label="Tutup">&times;</button>
            <div class="popup-icon" id="popupIcon"><i class="fas fa-gift"></i></div>
            ...
            <a href="https://t.me/youzin_crabz" class="btn btn-primary ripple tg-link" target="_blank" rel="noopener" id="popupCta">
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-inner">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="https://t.me/youzin_crabz" class="nav-cta ripple tg-link" target="_blank" rel="noopener"><i class="fab fa-telegram-plane"></i> Order</a></li>
            </ul>
        ...
        <div class="container">
            ...
            <div class="server-grid">
                <div class="server-card featured animate fade-left" data-animate>
                    <div class="server-flag"><i class="fas fa-flag"></i> SG</div>
                    ...
                    <a href="https://t.me/youzin_crabz" class="btn btn-primary ripple tg-link" target="_blank" rel="noopener"><i class="fab fa-telegram-plane"></i> Order Sekarang</a>
                </div>
                <div class="server-card animate scale-in" data-animate>
                    <div class="server-flag"><i class="fas fa-flag"></i> ID</div>
                    ...
                    <div class="server-price"><span class="amount">Rp 10.000</span><span class="period">/Bulan</span></div>
                    <p class="server-price-alt">Rp 15,62 /Jam (Pay As Go)</p>
                    <a href="https://t.me/youzin_crabz" class="btn btn-outline ripple tg-link" target="_blank" rel="noopener"><i class="fab fa-telegram-plane"></i> Order Sekarang</a>
                </div>
                <div class="server-card animate fade-right" data-animate>
                    <div class="server-flag"><i class="fas fa-globe"></i></div>
                    <h3>Always On</h3>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                <div class="pricing-card animate fade-left" data-animate>
                    ...
                    <a href="https://t.me/youzin_crabz" class="btn btn-outline ripple tg-link" target="_blank" rel="noopener">Pilih Paket</a>
                </div>
                <div class="pricing-card popular animate scale-in" data-animate>
                    ...
                    <a href="https://t.me/youzin_crabz" class="btn btn-primary ripple tg-link" target="_blank" rel="noopener">Pilih Paket</a>
                </div>
        ...
        <div class="container">
            <div class="cta-card animate scale-in" data-animate>
                ...
                <div class="cta-buttons">
                    <a href="https://t.me/youzin_crabz" class="btn btn-primary ripple tg-link" target="_blank" rel="noopener"><i class="fab fa-telegram-plane"></i> Order via Telegram</a>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-links">
                ...
                <a href="#harga">Harga</a><a href="#faq">FAQ</a><a href="/ordervpn/topup.php"><i class="fas fa-credit-card"></i> Top Up</a>
        ...
        function loadPromo() {
            fetch(apiUrl('/ordervpn/api/get_promo.php'))
                ...
                .then(function(data) {
                    ...
                    if (data.icon) document.getElementById('popupIcon').innerHTML = data.icon;
                    if (data.cta_text) document.getElementById('popupCta').innerHTML = '<i class="fab fa-telegram-plane"></i> ' + escapeHtml(data.cta_text);
        ...
        function loadSiteSettings() {
            fetch(apiUrl('/ordervpn/api/get_settings.php'))
                ...
                .then(function(s) {
                    ...
                    if (s.footer_text) {
                        document.getElementById('footerText').innerHTML = '&copy; ' + new Date().getFullYear() + ' ' + escapeHtml(s.site_name) + ' — ' + escapeHtml(s.footer_text) + '. All rights reserved.';
                    }
                    if (s.telegram_link) {
...
_ordervpn_deploy_files() {
    ...
    echo "" | base64 -d > "$DIR"/api/update_profile.php
    # api/verify_email_change.php
    echo "" | base64 -d > "$DIR"/api/verify_email_change.php
    # api/cancel_email_change.php
    echo "" | base64 -d > "$DIR"/api/cancel_email_change.php
    chmod 644 "$DIR"/api/cancel_email_change.php
    chmod 644 "$DIR"/api/verify_email_change.php
    # api/logout.php
    ...
    # === NEW ADMIN FEATURES ===
    echo "" | base64 -d > "$DIR"/api/get_settings.php
    chmod 644 "$DIR"/api/get_settings.php

    echo "" | base64 -d > "$DIR"/api/get_announcements.php
    chmod 644 "$DIR"/api/get_announcements.php
    echo "" | base64 -d > "$DIR"/api/get_promo.php
    chmod 644 "$DIR"/api/get_promo.php
    echo "" | base64 -d > "$DIR"/admin/announcements.php
    chmod 644 "$DIR"/admin/announcements.php
    echo "" | base64 -d > "$DIR"/admin/promotions.php
    chmod 644 "$DIR"/admin/promotions.php
    echo "" | base64 -d > "$DIR"/admin/settings.php
    chmod 644 "$DIR"/admin/settings.php

    echo "" | base64 -d > "$DIR"/admin/payment.php
    chmod 644 "$DIR"/admin/payment.php

    echo "" | base64 -d > "$DIR"/admin/dashboard.php
    chmod 644 "$DIR"/admin/dashboard.php

    # === TOPUP & PAYMENT PAGES ===
    echo "" | base64 -d > "$DIR"/api/get_payment_info.php
    chmod 644 "$DIR"/api/get_payment_info.php
    echo "" | base64 -d > "$DIR"/topup.php
    chmod 644 "$DIR"/topup.php
    echo "" | base64 -d > "$DIR"/data/payment.json

    # forgot_password.php
    echo "" | base64 -d > "$DIR"/forgot_password.php
    chmod 644 "$DIR"/forgot_password.php
    # reset_password.php
    echo "" | base64 -d > "$DIR"/reset_password.php
    chmod 644 "$DIR"/reset_password.php
    chmod 644 "$DIR"/data/payment.json
}
